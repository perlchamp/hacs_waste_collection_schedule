...
- click on the `Pre-Release` switch in the `Diagnostics` area
  ![Switch Pre-Release](pictures/Pre-release_ok.png)
  *Image: activate switch pre-release*

- click on the gear symbol → activate the `enabled` option → click on `update`.
  ![Activate pre-release sensor switch](pictures/Pre-release_aktivieren_ok.png)
  *Image: Activate pre-release sensor switch*

- confirm activation
  ![Confirm activation](pictures/Bestätigung_Pre-Release_aktivieren_ok.png)
  *Image: Confirm activation of the switch*

- Activate pre-release sensor under WCS
  ![Activate pre-release sensor under WCS](pictures/Pre-release_aktivieren_2_ok.png)
  *Image: Activate WCS pre-release sensor*

- The upgrade is now available
  ![Upgrade is available](pictures/Pre-release_aktivieren_3_ok.png)
...
- Click on `Update available` → click on `Update` to then update WCS to the current version (here: V 3.0.0-beta4).
  ![Upgrade to the current version](pictures/WCS_upgraden_ok.png)
  *Image: Update to the current version*

- HA → Settings → Restart HA
  ![Restart HA](pictures/WCS_Restart_required_ok.png)
  *Image: Restart HA*

  ![Confirm restart](pictures/WCS_Restart_bestätigen_ok.png)
